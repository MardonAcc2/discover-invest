    ...
    <div className="flex pt-30 flex-col lg:flex-row gap-15 w-full min-h-screen px-4 py-10 bg-white text-black">
      ...
      <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
        ...
        <div className="space-y-4 text-gray-700">
          ...
          <Image src={phone} height={16} width={16} alt="img" ></Image><p> +998 95 475 20 40</p>
      ...
      <form className="w-full lg:w-1/2 space-y-4">
        ...
        <button type="submit" className="bg-orange-400 hover:bg-orange-500 text-white px-6 py-3 rounded">
          Send
        </button>
      </form>
    </div>
