...
const Video = ({num}) => {
  ...
  return (
    ...
    <div className='pt-20 relative'>
        ...
        {modal?<VideoModal href={modalid} info={modal} />:""}
        ...
        <div className={styles.videoblog}>
                ...
                <div className='col-sm-4 videoblog_main_item'>
                    <div className={styles.videoblog_img}>
                        <Image src={item.img} width={700} height={500} alt="img"/>
                        </div> </div>
                        <p onClick={(e)=>{setModal(!modal); setModalid(item.href)}} className={styles.link_video_title}>
        {item.title}    </p>
