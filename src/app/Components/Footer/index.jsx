...
const Footer = () => {
  return (
    ...
    <div className='custom_container flex justify-between flex-col sm:flex-row'><div>
        <div>
            <div><Image className='pb-8' height={48} src={logo} alt="logo"/></div>
            <hr />
            <div><ul>
                <li className='flex gap-3'><Image src={phone} height={16} width={16} alt="phone"></Image><Link href="tel:+998964782040"> +998 96 478 20 40</Link></li>
